...
from pote.common import bundle_path
from pote.common import Config
from pote.common import is_listy
...
def cleanupbridget(glbs):
    ...
    if in_vscode_notebook():
        # from bridget.bridge_widget import _set_brdimport
        # from bridget.bridge import _set_bridge
        bridge_widget = importlib.import_module('bridget.bridge_widget')
        bridge = importlib.import_module('bridget.bridge')
        bridge_widget._set_brdimport(None)
        bridge._set_bridge(None)
