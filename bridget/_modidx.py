...
d = { 'settings': { 'branch': 'main',
                ...
                'lib_path': 'bridget'},
  'syms': { 'bridget.anydoc': {},
            'bridget.bridge': { 'bridget.bridge.BCanvas': ('bridge.html#bcanvas', 'bridget/bridge.py'),
            ...
            'bridget.nbdev_rt': { 'bridget.nbdev_rt.NBDev_rt': ('nbdev_rt.html#nbdev_rt', 'bridget/nbdev_rt.py'),
                                  'bridget.nbdev_rt.NBDev_rt.on_state_update': ( 'nbdev_rt.html#nbdev_rt.on_state_update',
                                                                                 'bridget/nbdev_rt.py'),
                                  'bridget.nbdev_rt.nb_export': ('nbdev_rt.html#nb_export', 'bridget/nbdev_rt.py')},
            'bridget.prompt': { 'bridget.prompt.Prompt': ('prompt.html#prompt', 'bridget/prompt.py'),
                                'bridget.prompt.Prompt.export': ('prompt.html#prompt.export', 'bridget/prompt.py')},
